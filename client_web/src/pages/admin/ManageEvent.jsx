			...
			<div className='rounded-[8px]'>
				<table className='w-full'>
					<thead className='h-[68px] rounded-[8px] bg-white shadow-table'>
						<tr className=''>
							<td className='w-[5%] text-[14px] font-[700] text-[#5F5F5F] text-center py-2'>
								#
							</td>
							<td className='w-[15%] text-[14px] font-[700] text-[#5F5F5F] text-center'>
								Ảnh
							</td>
							<td className='w-[30%] text-[14px] font-[700] text-[#5F5F5F]'>
								Tên sự kiện
							</td>
							<td className='w-[10%] text-[14px] font-[700] text-[#5F5F5F] text-center'>
								Loại
							</td>
							<td className='w-[10%] text-[14px] font-[700] text-[#5F5F5F] text-center'>
								Trạng thái
