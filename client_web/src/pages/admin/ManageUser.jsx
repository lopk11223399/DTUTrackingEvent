...
const ManageUser = () => {
  ...
  return (
    <div className="w-full h-full py-2 px-[20px]">
      <h1 className=" uppercase font-[500] text-[#408A7E] text-3xl mb-2">
        Quản lý Người dùng
      </h1>
      <div className="flex  justify-between">
        <div className=" pt-2">
          <button
            ...
            className="bg-[#408A7E] text-[#fff] leading-[20px] font-normal items-center pt-[5px] pr-[10px] pb-[5px] pl-[10px] rounded-md"
          >
            Reset Point
          </button>
        </div>
        <div className="flex mb-2 rounded-[7px] border border-[#408A7E]">
          <input
            type="text"
          ...
          <label
            htmlFor="search-user"
            className="bg-[#408A7E] h-[40px] px-[14px] flex items-center justify-center cursor-pointer rounded-tr-[5px] rounded-br-[5px]"
          >
      ...
      <div className="rounded-[8px] bg-[#fff] ">
        <table className="w-full">
          <thead className=" text-[#408A7E]   border-b border-[#408A7E]">
            <tr className=" ">
              {showCheckBox && <td></td>}
            ...
            {data.length > 0 &&
              data.map((user, index) => (
                <tr
                  ...
                  key={user.id}
                  className="hover:bg-[#408A7E]  hover:text-white hover:opacity-[0.85] duration-95 ease-in-out cursor-pointer"
                >
                  {showCheckBox && (
                    <td className="pl-2">
                      <input
