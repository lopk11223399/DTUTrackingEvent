      ...
      <div className="rounded-[8px]">
        <table className="w-full">
          <thead className="h-[50px] rounded-t-[8px] text-[#408A7E] border border-b-[#408A7E] shadow-table">
            <tr className="">
              <td className="w-[10%] text-[14px] font-[700] text-center py-2">
                #
              </td>
              <td className="w-[30%] text-[14px] font-[700] pl-2 py-2">
                Họ & tên
              </td>
              <td className="w-[15%] text-[14px] font-[700] text-center py-2">
                Ngày sinh
              </td>
              <td className="w-[15%] text-[14px] font-[700] text-center py-2">
                Giới tính
              </td>
              <td className="w-[20%] text-[14px] font-[700] text-center py-2">
                Vai trò
              </td>
              <td className="w-[10%] text-[14px] font-[700] text-center py-2">
                Số point
          ...
          <tbody className="text-center">
            {data?.map((user, index) => (
              ...
              >
                ...
                <td className="w-[30%] pl-2 text-left">{user.name}</td>
