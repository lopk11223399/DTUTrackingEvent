      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 mr-auto ml-auto flex items-center justify-center">
        <div className="w-[400px] flex flex-col items-center p-4 gap-5 rounded-[20px] bg-[#fff] shadow-md">
          ...
          <div className="flex flex-col w-full">
            <label
              htmlFor="username"
              className="capitalize self-start mb-[10px] text-[16px] font-[400] font-semibold text-black"
            >
              tài khoản
            </label>
            <input
          ...
          <div className="flex flex-col w-full">
            ...
            <div className=" relative">
              <input
                ...
                className="bg-[#F5F5F5] w-full outline-none py-[10px] px-[15px] text-[16px] font-[400] rounded-[10px]"
              />
              <button
